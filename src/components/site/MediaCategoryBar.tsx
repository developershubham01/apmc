    ...
    >
      <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
        <div className="flex items-center gap-3">
          <span className="hidden h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-navy text-gold ring-1 ring-gold/30 sm:inline-flex">
            ...
            <Link
              ...
              className={cn(
                ...
                !current
                  ...
                  : "bg-white text-ink-600 ring-1 ring-border hover:text-royal"
              )}
            >
              All Media
            </Link>
            {mediaCategories.map((category) => (
              ...
              >
                ...
                <ArrowRight
                  className={cn(
                    "h-3 w-3",
                    current === category.slug ? "text-gold" : "text-ink-600/50"
                  )}
                />
              </Link>
            ))}
